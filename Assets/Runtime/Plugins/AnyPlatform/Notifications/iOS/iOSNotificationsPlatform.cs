...
namespace RModule.Runtime.Plugins.Notifications.iOS {
	/// <summary>
	...
	public class iOSNotificationsPlatform : IGameNotificationsPlatform<iOSGameNotification>,
		...
		public void OnForeground() {
			_notificationsCount = iOSNotificationCenter.ApplicationBadge;
		...
		public int GetNotificationsCountAndReset() {
			int count = _notificationsCount;
